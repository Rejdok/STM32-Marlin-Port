...
#define STRING_CONFIG_H_AUTHOR "(Rejdok STM32 Marlin Port!)" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp 34.35
  #define  DEFAULT_Ki 4.26
  #define  DEFAULT_Kd 69.30
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {(20)*8,(20)*8,((4*200)/1.25)*8,(25.520833333333333333333333333333)*8}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 300}    // (mm/sec)
